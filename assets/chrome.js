...
(function () {
  ...
  function ensureFooter() {
    var links = [
      ["/method/", "Method"], ["/agents/", "Agents"], ["/panels/", "Panels"],
      ["/projects/", "Projects"], ["/intake/", "Intake"], ["/xray/", "X-ray"],
      ["/governor/", "Governor"], ["/privacy/", "Privacy"], ["/terms/", "Terms"],
  ...
  function killNoise() {
    var nodes = document.querySelectorAll(".cli, #statuscli, #cliout, .liveflow-motto, #liveReplay, .strip.more");
