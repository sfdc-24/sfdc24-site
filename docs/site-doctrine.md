...
**Skateboarder Mode:** Fall fast / fall early — misses are lessons, not blame. The 24 is the board + 24 hour clock triad. Log ETA outcomes; next ETA cites `course_correct`. Method: `/method/#skateboarder`. History: `/history/`.
